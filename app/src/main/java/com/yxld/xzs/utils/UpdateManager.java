...
import com.yxld.xzs.activity.Login.SplashActivity;
...
public class UpdateManager {
    ...
    private static final String saveFileName = savePath
            + "UpdateRelease.apk";//修改为和欣社区不一样的文件名
...
//        Log.d("geek", "apkUrl" + apkUrl);
    ...
    // 外部接口让主Activity调用
    public void checkUpdateInfo(String versionCode, String versionMsg, Integer
            versionIsCompulsory) {
        showNoticeDialog(versionCode, versionMsg, versionIsCompulsory);
    }

    private void showNoticeDialog(String versionCode, String versionMsg, Integer
			versionIsCompulsory) {
    ...
    private void installApk() {
        if (Build.VERSION.SDK_INT >= 24) {//判读版本是否在7.0以上
			...
			Uri apkUri = FileProvider.getUriForFile(mContext, "com.yxld.xzs.fileprovider", apkfile);//在AndroidManifest中的android:authorities值
