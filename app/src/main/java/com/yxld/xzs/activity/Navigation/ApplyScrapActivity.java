...
public class ApplyScrapActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apply_scrap);
...
//            data.add("" + i);
//        }
//        final ApplyScrapAdapter adapter = new ApplyScrapAdapter(data);
...
//                } else {
//                    Intent intent = new Intent(ApplyScrapActivity.this, ApplyScrapCheckActivity.class);
...
//        });
    ...
    private void init() {
        ...
        // WebView加载web资源
        WwebView.loadUrl(API.IP_PRODUCT + "/scrapList.html?uuid=" + Contains.uuid);
...
//        WwebView.loadUrl("javascript:callFromJava('1')");
    ...
    public void onBackPressed() {
        if (WwebView.canGoBack()){
            if(WwebView.getUrl().equals(API.IP_PRODUCT + "/scrapList.html?uuid=" + Contains.uuid)){
                super.onBackPressed();
            }else{
                WwebView.goBack();
            }
