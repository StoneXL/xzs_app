 ...
 * @Date 2018/4/9.
 */
public class AccountSafeActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener, FingerListener {
    ...
    protected void initData() {
        ...
        mArtlChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AccountSafeActivity.this, PatternCheckActivity.class);
    ...
    private void checkFinger(boolean isChecke) {
        dialog = new FingerDialog(AccountSafeActivity.this);
        ...
        jsFingerUtils.startListening(AccountSafeActivity.this);
    }
