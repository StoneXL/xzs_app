...
public class RimDeliveryAdapter extends BaseQuickAdapter<RimOrderBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder baseViewHolder, final RimOrderBean orderBean) {
        ...
        baseViewHolder.setVisible(R.id.auto_delivery, true);
        ...
        baseViewHolder.addOnClickListener(R.id.bt_client_phone).addOnClickListener(R.id
                .bt_shop_phone).addOnClickListener(R.id.bt_confirm_delivery);
    }
}
