...
public class RimRobAdapter extends BaseQuickAdapter<RimOrderBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder baseViewHolder, final RimOrderBean orderBean) {
        ...
        baseViewHolder.setText(R.id.tv_location, orderBean.getOrderUserAddress()).setText(R.id
                ...
                .getOrderSendMoney());
        baseViewHolder.setText(R.id.bt_rob, "抢单").setVisible(R.id.bt_rob, true);

//        List<RimOrderDetailBean> detailList = orderBean.getDetailList();
