package com.yxld.xzs.view.datepicker;
...
public class WheelView extends View {
	...
	/** 顶部和底部阴影的颜色 */
//	private static final int[] SHADOWS_COLORS = new int[] { 0x55000000, 0x00ffffff, 0x55000000 };
	/** 顶部和底部阴影的颜色 */
//	private static final int[] SHADOWS_COLORS = new int[] { 0x00ffffff, 0x00ffffff, 0xffffffff };
	private int[] SHADOWS_COLORS = new int[] { 0xaaE9E9E9,
			0x55E9E9E9, 0x00E9E9E9 };
//	private static final int[] SHADOWS_COLORS = new int[] { 0x55111111,
//		0x00AAAAAA, 0x55AAAAAA };
...
//					R.drawable.xx_view_scroll_picker_bar);
			centerDrawable = getContext().getResources().getDrawable(R.mipmap.time_bubble_line);
		}
