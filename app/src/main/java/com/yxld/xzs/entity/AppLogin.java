...
public class AppLogin extends BaseBack {
	private AppLogin rows;
	private String uuid;
	...
	public AppLogin getRow() {
		return rows;
	}

	public void setRows(AppLogin rows) {
		this.rows = rows;
	}
	// Fields
	/** 管理员ID */
	...
	public AppLogin(Integer adminId, String adminUserName,
