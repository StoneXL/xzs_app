...
import com.yxld.xzs.activity.camera.CameraActivity;
...
public class P2PListener implements IP2P {
    ...
    public void vReject(String deviceId, int reason_code, int exCode1, int exCode2) {
        ...
        DemoApplicationLike.getInstance().sendBroadcast(intent);
    }
    ...
    public void vAccept(int type, int state) {
        ...
        DemoApplicationLike.getInstance().sendBroadcast(accept);
    }
